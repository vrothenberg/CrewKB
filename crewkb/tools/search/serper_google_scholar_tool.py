"""
SerperGoogleScholarTool for searching academic literature using Serper's API.

This module provides a tool for searching academic literature using the
Serper.dev Google Scholar API endpoint, which returns structured results.
"""
...
class SerperGoogleScholarToolInput(BaseModel):
    """Input schema for SerperGoogleScholarTool."""
...
class SerperGoogleScholarTool(BaseTool):
    """
    Tool for searching academic literature using Serper's Google Scholar API.
    
    This tool allows agents to search for academic papers and research.
    It uses the Serper.dev Google Scholar API endpoint for structured results.
    """
    
    name: str = "SerperGoogleScholarTool"
    description: str = "Search Google Scholar using Serper API"
    args_schema: type[BaseModel] = SerperGoogleScholarToolInput
